# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2018-04-29 05:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='graduate_time',
            field=models.CharField(default='2010-10-10', max_length=20),
        ),
        migrations.AddField(
            model_name='user',
            name='id_number',
            field=models.CharField(default='440902199312123232', max_length=30),
        ),
        migrations.AddField(
            model_name='user',
            name='job',
        ...
        migrations.AddField(
            model_name='user',
            name='phone',
            field=models.CharField(default='13760419846', max_length=30),
        ),
        migrations.AddField(
            model_name='user',
            name='school',
            field=models.CharField(default='深圳职业技术学院', max_length=30),
        ),
        migrations.AddField(
            model_name='user',
            name='sex',
