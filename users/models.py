...
class User(AbstractUser):
    ...
    id_number = models.CharField(max_length=30, default='440902199312123232')

    xue_li = models.CharField(max_length=30, default='本科')
    school = models.CharField(max_length=30, default='深圳职业技术学院')
    graduate_time = models.CharField(max_length=20, default='2010-10-10')
    job_join_time = models.CharField(max_length=20, default='2011-10-10')
    team_belong =  models.CharField(max_length=20, default='C640')

    phone = models.CharField(max_length=30, default='13760419846')
